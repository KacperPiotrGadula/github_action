...
def generate_output():
    ...
    TIMEZONE_MAP = {
        "EMEA_CEST": ZoneInfo("Europe/Warsaw"),  # CEST (Daylight Saving Time)
        "EMEA_CET": ZoneInfo("Europe/Warsaw"),   # CET (Standard Time)
    ...
    base_timezone = f"EMEA_{selected_timezone}" if selected_region == "EMEA" else selected_region
