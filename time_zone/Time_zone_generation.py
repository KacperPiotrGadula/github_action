...
def generate_output():
    ...
    if end_time == "24:00":
        # 24:00 to 00:00 the following day
    ...
    if start_date_banner_str == end_date_banner_str and start_date_banner_UTC == end_date_banner_UTC:
        ...
        if start_date_banner_str == end_date_banner_str and start_date_banner_UTC != end_date_banner_UTC:
            ...
            if start_date_banner_str != end_date_banner_str and start_date_banner_UTC == end_date_banner_UTC:
                output_lines.append(f"{start_time_str} {start_date_banner_str} - {end_time_str} {end_date_banner_UTC} {time_zone}" f" ({start_date_banner_UTC} {start_time_UTC_str}  - {end_time_UTC_str} UTC)")
            else:
